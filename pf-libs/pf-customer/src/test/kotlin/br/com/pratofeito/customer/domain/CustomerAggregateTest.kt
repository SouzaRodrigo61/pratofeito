...
class CustomerAggregateTest {
    ...
    fun createCustomerTest() {
        val name = PersonName("Rodrigo", "Santos")
        ...
        val customerCreatedEvent = CustomerCreatedEvent(
            name,
            orderLimit,
            createCustomerCommand.targetAggregateIdentifier,
            auditEntry)
    ...
    fun createCustomerOrderTest() {
        val name = PersonName("Rodrigo", "Santos")
        val createCustomerOrderCommand = CreateCustomerOrderCommand(
